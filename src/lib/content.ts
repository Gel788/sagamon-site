...
export const bio = [
  ...
  "Играет джаз, рок, хип-хоп, fusion и world music — от камерных клубов до многотысячных арен. Барабанщик Скриптонита. Сотрудничал с Joe Lynn Turner, Steve Turre, Karl Frierson и оркестром Игоря Бутмана.",
] as const;
